...
export const NavBar = () => (
        <header className="nav-bar">
            <nav>
                <button class="md:hidden flex text-primary hover:opacity-70 transition-opacity duration-200">
                ...
                <div className="flex-ic gap-md">
                    <button class="hidden md:flex text-primary hover:opacity-70 transition-opacity duration-200">
                        <span class="material-symbols-outlined" data-icon="search">search</span>
                    </button>
                    <NavLink to="/cart" >
